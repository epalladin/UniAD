...
class UniADLidar(UniADTrackLidar):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(UniADLidar, self).__init__(**kwargs)
        if seg_head:
    ...
    def forward_dummy(self, points):
        dummy_metas = None
        return self.forward_test(points=points, img_metas=[[dummy_metas]])
    ...
    def forward_train(self,
        ...
        """Forward training function for the model that includes multiple tasks, such as tracking, segmentation, motion prediction, occupancy prediction, and planning.
            ...
            Args:
            points (torch.Tensor, optional): Tensor containing lidar pc of each sample with shape (N, P, 4). Defaults to None.
        ...
        losses_track, outs_track = self.forward_track_train(points, gt_bboxes_3d, gt_labels_3d, gt_past_traj, gt_past_traj_mask, gt_inds, gt_sdc_bbox, gt_sdc_label,
    ...
    def forward_test(self,
        ...
        result_track = self.simple_test_track(points, l2g_t, l2g_r_mat, img_metas, timestamp)
